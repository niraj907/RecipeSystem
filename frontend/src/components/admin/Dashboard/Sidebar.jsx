...
const Sidebar = () => {
  ...
  return (
    <>
      {/* Mobile Overlay */}
      <div
        className={`fixed inset-0 z-[50] bg-black opacity-50 transition-opacity sm:hidden ${
      ...
      {/* Sidebar */}
      <div
        className={`fixed z-[50] h-screen p-5 flex flex-col gap-5 bg-[#FEF5EC] transition-all duration-300 ${
