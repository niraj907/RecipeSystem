...
const ForgortPasswordAdmin = () => {
  const [email, setEmail] = useState("");
  const [isSubmitted, setIsSubmitted] = useState(false);
  const { isLoading, error, forgotPassword } = useAdminStore();
        ...
        <div className="w-full max-w-md bg-[#FEF5EC] rounded-lg shadow-md p-6 sm:p-8">
          ...
          <div className="w-full max-w-md mt-4">
            <div className="px-6 py-4 bg-[#f67b24] rounded-lg text-center">
              <Link to="/admin-login" className="text-sm text-white hover:underline flex items-center justify-center">
...
export default ForgortPasswordAdmin