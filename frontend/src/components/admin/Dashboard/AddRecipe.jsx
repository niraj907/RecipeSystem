...
const AddRecipe = () => {
  ...
  return (
  <div className="min-h-screen bg-gray-50 p-10 sm:p-6 md:p-10">
    <main className="mx-auto px-0 sm:px-4 lg:pl-[15rem] py-8 sm:py-[4rem] max-w-[83rem]">
      <div className="bg-white rounded-lg shadow-lg overflow-hidden">
        <div className="p-4 sm:p-6">
          <h2 className="text-xl sm:text-2xl font-bold text-gray-800 mb-4 sm:mb-6 flex items-center">
            <span className="inline-block w-6 h-6 sm:w-8 sm:h-8 bg-orange-500 rounded-full mr-2 sm:mr-3"></span>
            Add New Recipe
          </h2>
