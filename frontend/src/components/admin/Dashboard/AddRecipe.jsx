...
//         <button
//           type="submit"
//           className="w-full bg-orange-600 text-white p-3 rounded text-lg font-semibold hover:bg-orange-700 transition"
//         >
//           Add Recipe
...
const AddRecipe = () => {
  ...
  const [nepaliVideoName, setNepaliVideoName] = useState("");
  const [nepaliVideoLink, setNepaliVideoLink] = useState("");
  const [hindiVideoName, setHindiVideoName] = useState("");
  const [hindiVideoLink, setHindiVideoLink] = useState("");
  const [englishVideoName, setEnglishVideoName] = useState("");
