...
//         await fetchFavorites(user.id);
//       } else {
//         clearFavorites(); // Clear favorites when user logs out
//       }
//     };
//     fetchData();
//   }, [isAuthenticated, user, fetchAllRecipes, fetchFavorites, clearFavorites]);
...
// it is better that perivous code
...
const Recipe = () => {
  ...
  useEffect(() => {
    ...
    fetchData();
  }, [isAuthenticated, user?.id, fetchAllRecipes, fetchFavorites, clearFavorites]);
